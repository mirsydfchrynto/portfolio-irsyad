        ...
        <div className="grid lg:grid-cols-12 gap-20 items-center">
          ...
          >
            <div className="space-y-10">
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="w-16 h-[2px] bg-[#ff0055]" />
                  <span className="font-mono text-[11px] uppercase tracking-[0.5em] text-[#ff0055] font-black block select-none">
                    Digital Architect
                  </span>
                </div>
                <span className="font-mono text-[10px] text-white/20 tracking-widest uppercase">Est. 2005 // IR_992</span>
              </motion.div>
              
              <h1 className="giant-type select-none leading-[0.85] tracking-[-0.08em]">
                M. Irsyad <br />
                <span className="text-[#ff0055] drop-shadow-[0_0_50px_rgba(255,0,85,0.4)]">Fachryanto</span>
              </h1>
              ...
              <div className="text-xl md:text-2xl font-display font-medium text-white/30 tracking-tighter lowercase flex items-center gap-6">
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#ff0055] animate-ping opacity-40" />
                ...
                <span className="font-mono text-xs text-white/20 tracking-[0.3em] uppercase">Core_System_5.0</span>
              </div>
            </div>
            
            <div className="space-y-16">
              <p className="paragraph-editorial text-xl md:text-2xl font-medium leading-[1.4] border-l-4 border-[#ff0055]/40 pl-12 py-2 text-white/70 italic">
              ...
              <div className="flex flex-wrap gap-10 pt-4">
                <Magnetic strength={0.25}>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-[#ff0055] translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-[0.16,1,0.3,1]" />
                  </a>
                </Magnetic>
                ...
                <Magnetic strength={0.25}>
                  <a 
                    href="#resume"
                    className="px-12 py-6 border-2 border-white/10 hover:border-[#ff0055] text-[13px] font-mono tracking-[0.2em] text-white/40 hover:text-white transition-all bg-white/[0.01] flex items-center gap-5 uppercase font-black"
                  >
            ...
            <div className="flex flex-wrap gap-12 pt-16 border-t border-white/5 max-w-3xl font-mono text-[11px] text-white/10 select-none uppercase tracking-[0.4em]">
              <div className="flex items-center gap-4 group cursor-crosshair hover:text-[#ff0055] transition-all">
                <Shield size={18} className="text-[#ff0055]/40 group-hover:text-[#ff0055] group-hover:scale-125 transition-all" />
                <span>Integrity: <strong className="text-white/40">Strict</strong></span>
              </div>
              <div className="flex items-center gap-4 group cursor-crosshair hover:text-[#ff0055] transition-all">
                <Terminal size={18} className="text-[#ff0055]/40 group-hover:text-[#ff0055] group-hover:scale-125 transition-all" />
                <span>Stack: <strong className="text-white/40">Hybrid_Native</strong></span>
              </div>
              <div className="flex items-center gap-4 group cursor-crosshair hover:text-[#ff0055] transition-all">
                <Cpu size={18} className="text-[#ff0055]/40 group-hover:text-[#ff0055] group-hover:scale-125 transition-all" />
          ...
          >
            ...
            <div className="absolute -inset-24 bg-[#ff0055]/5 rounded-full blur-[180px] pointer-events-none animate-pulse" />
            
            <div className="relative group w-full max-w-[480px] aspect-[4/5] p-5 bg-[#050507] border border-white/10 shadow-[60px_60px_120px_rgba(0,0,0,0.9)] hover:border-[#ff0055]/40 transition-all duration-1000 overflow-hidden perspective-1000">
              ...
              <div className="absolute top-10 left-10 z-20 flex flex-col gap-2">
                <div className="font-mono text-[11px] text-[#ff0055] bg-black/95 px-5 py-2 border border-[#ff0055]/40 backdrop-blur-2xl uppercase tracking-[0.4em] font-black shadow-[0_0_30px_rgba(255,0,85,0.3)]">
                  NODE_ID: IR-992
                </div>
              ...
              <div className="absolute bottom-10 right-10 z-20 flex flex-col items-end gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  <div className="w-1 h-1 bg-[#ff0055]" />
                  <div className="w-8 h-1 bg-[#ff0055]" />
                </div>
              </div>
              
              {/* Architectural Physical Edge Accents */}
              <div className="absolute top-0 right-0 w-40 h-40 border-t-2 border-r-2 border-[#ff0055]/30 pointer-events-none group-hover:w-full group-hover:h-full transition-all duration-1000 ease-in-out" />
              <div className="absolute bottom-0 left-0 w-40 h-40 border-b-2 border-l-2 border-[#ff0055]/30 pointer-events-none group-hover:w-full group-hover:h-full transition-all duration-1000 ease-in-out" />
            </div>
          </motion.div>
