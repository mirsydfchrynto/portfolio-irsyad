  ...
  return (
    <div className="space-y-64 md:space-y-96">
      ...
      >
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-[#ff0055]/5 blur-[150px] pointer-events-none group-hover/main:opacity-100 opacity-50 transition-opacity duration-1000" />
        
        <div className="relative flex flex-wrap items-baseline justify-between gap-8 border-b border-white/5 pb-12">
          <div className="flex items-center gap-5">
            <span className="text-[14px] font-mono text-[#ff0055] font-black tracking-widest">[SCENE_04]</span>
          ...
          <div className="flex items-center gap-4 font-mono text-[10px] text-white/20 uppercase tracking-[0.4em] font-black">
            <ShieldCheck size={14} className="text-[#ff0055] animate-pulse" />
        ...
        <div className="relative grid lg:grid-cols-12 gap-20 items-start">
          ...
          <div 
            ...
            className="lg:col-span-5 aspect-[4/5] bg-[#020203] border border-white/10 overflow-hidden relative group/img cursor-pointer transition-all duration-1000 hover:border-[#ff0055]/50 hover:shadow-[0_0_80px_rgba(255,0,85,0.15)]"
          >
            ...
            <div className="absolute bottom-12 left-12 flex items-center gap-5 translate-y-8 opacity-0 group-hover/img:translate-y-0 group-hover/img:opacity-100 transition-all duration-700 ease-out z-20">
              ...
              <div className="w-12 h-12 bg-[#ff0055] flex items-center justify-center text-white shadow-2xl">
          ...
          <div className="lg:col-span-7 space-y-16">
            <div className="space-y-10">
              <div className="flex flex-wrap gap-4">
                <div className="inline-flex items-center gap-4 px-5 py-2 border border-[#ff0055]/40 bg-[#ff0055]/10 text-[#ff0055] font-mono text-[11px] uppercase tracking-[0.3em] font-black shadow-[0_0_30px_rgba(255,0,85,0.2)]">
              ...
              <p className="text-[#ff0055] font-mono text-[12px] tracking-[0.4em] uppercase font-black opacity-80 pl-2 border-l-2 border-[#ff0055]">
              ...
              {productionExperience.metrics.map((metric, idx) => (
                <li key={idx} className="flex gap-8 items-start group/metric">
                  <div className="flex flex-col items-center pt-2">
                    <span className="text-[#ff0055] font-black font-mono text-xl">&gt;&gt;</span>
                    <div className="w-[1px] h-0 group-hover/metric:h-12 bg-[#ff0055]/20 transition-all duration-700" />
                  </div>
            ...
            <div className="flex flex-wrap gap-10 pt-4">
              <Magnetic strength={0.2}>
                <button
                  onClick={() => setSelectedProject(productionExperience)}
                  className="px-14 py-7 bg-white text-black font-mono text-[13px] font-black tracking-widest uppercase hover:bg-[#ff0055] hover:text-white transition-all duration-700 shadow-2xl"
                >
                  DEEP_DIVE_PROTOCOL
                </button>
              </Magnetic>
              {productionExperience.url && (
                <Magnetic strength={0.2}>
                  <a
                    ...
                    className="px-12 py-7 border-2 border-white/10 hover:border-[#ff0055] text-[13px] font-mono tracking-widest text-white/40 hover:text-white flex items-center gap-5 transition-all uppercase font-black bg-white/[0.01]"
                  >
      ...
      <motion.section 
        ...
        {...fadeInUp}
      >
        <div className="flex flex-wrap items-baseline justify-between gap-12 border-b-2 border-[#ff0055]/30 pb-12">
          <div className="flex items-center gap-6">
            <span className="text-[14px] font-mono text-[#ff0055] font-black tracking-widest">[SCENE_05]</span>
