...
const SNIPPETS: Snippet[] = [
  {
    ...
    code: (
      <>
        ...
        <span className="text-[#ff0055] font-bold">package</span> com.securecbt.cbt_mobile<br/><br/>
        <span className="text-[#ff0055] font-bold">import</span> android.view.WindowManager<br/>
        <span className="text-[#ff0055] font-bold">import</span> io.flutter.embedding.android.FlutterActivity<br/>
        <span className="text-[#ff0055] font-bold">import</span> io.flutter.embedding.engine.FlutterEngine<br/>
        <span className="text-[#ff0055] font-bold">import</span> io.flutter.plugin.common.MethodChannel<br/><br/>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#ff0055] opacity-80">private val</span> CHANNEL = <span className="text-amber-300">"com.okeybimbel/security"</span><br/><br/>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#ff0055] opacity-80">super</span>.configureFlutterEngine(flutterEngine)<br/>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;window.addFlags(<span className="text-[#ff0055]">WindowManager</span>.LayoutParams.FLAG_SECURE)<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result.success(<span className="text-amber-400">null</span>)<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br/>
  ...
  },
  {
    ...
    code: (
      <>
        ...
        <span className="text-[#ff0055] font-bold">import</span> <span className="text-amber-300">'package:cloud_firestore/cloud_firestore.dart'</span>;<br/><br/>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-emerald-400">return</span> <span className="text-[#ff0055]">DateTime</span>.now(); <span className="text-white/30">// Fallback</span><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125;<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&#125;<br/>
        &#125;
      </>
  ...
  },
  {
    ...
    code: (
      <>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#125; <span className="text-emerald-400">catch</span> (e) &#123;<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#ff0055] opacity-60">// Fallback in-memory filter</span><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-emerald-400">return</span> _firestore<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.collection(<span className="text-amber-300">'queues'</span>)<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.where(<span className="text-amber-300">'shopId'</span>, isEqualTo: shopId)<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.snapshots()<br/>
...
export function CodeWorkspace() {
  ...
  return (
    <div className="relative group w-full max-w-xl">
      ...
      <div className="absolute -inset-2 bg-gradient-to-r from-[#ff0055]/30 to-rose-900/10 rounded-xl blur-2xl opacity-40 group-hover:opacity-100 transition duration-1000" />
      
      {/* Editor Window Container */}
      <div className="relative border border-white/10 bg-[#060608] w-full font-mono text-[11px] leading-relaxed shadow-[24px_24px_100px_rgba(0,0,0,0.95)] flex flex-col h-[420px] overflow-hidden transition-all duration-700 hover:border-[#ff0055]/30 brutal-card">
        ...
        <div className="bg-[#0a0a0c] flex border-b border-white/5 items-center justify-between px-6 h-14 select-none relative z-10">
          <div className="flex items-center gap-3">
            <span className="w-3 h-3 rounded-full bg-[#ff0055]/80 border border-[#ff0055]/40 animate-pulse" />
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-3 py-1 bg-[#ff0055]/10 border border-[#ff0055]/30">
              <div className="w-1.5 h-1.5 rounded-full bg-[#ff0055] animate-ping" />
              <span className="text-[9px] text-[#ff0055] font-black uppercase tracking-widest">Live</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#08080a] flex border-b border-white/5 items-center px-3 overflow-x-auto scrollbar-none select-none relative z-10">
          <div className="flex h-12">
            {SNIPPETS.map((snippet, idx) => (
              ...
              >
                <FileCode size={14} className={activeIdx === idx ? "text-[#ff0055]" : "text-white/5"} />
                <span className="tracking-widest uppercase">{snippet.filename}</span>
                {activeIdx === idx && (
                  <motion.div 
                    layoutId="activeTab"
                    className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#ff0055] shadow-[0_0_15px_rgba(255,0,85,0.8)]" 
                  />
                )}
              </button>
            ))}
        ...
        <div className="bg-[#ff0055]/[0.02] px-6 py-4 border-b border-white/5 text-white/40 text-[11px] flex items-start select-none relative z-10">
          <ChevronRight size={16} className="text-[#ff0055] mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="bg-[#0a0a0c] px-6 py-3 border-t border-white/5 flex justify-between items-center text-[9px] text-white/10 uppercase tracking-[0.3em] font-black select-none relative z-10">
          <div className="flex gap-6">
            <span className="hover:text-[#ff0055] transition-colors cursor-crosshair">Lang: {activeSnippet.language}</span>
            <span className="hover:text-[#ff0055] transition-colors cursor-crosshair">UTF-8</span>
          </div>
          <span className="text-[#ff0055]/40">LN {activeSnippet.filename === "MainActivity.kt" ? "53" : "76"}, COL 1</span>
        </div>
      </div>
    </div>
  );
